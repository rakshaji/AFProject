...
public class ExcelURLProcessor {
	 ...
	 * Logger.getLogger(ExcelURLProcessor.class.getName());
	 * 
	 * static { try { File logsDir = new File("logs"); if (!logsDir.exists()) {
	 * System.out.println("doesnot exist"); logsDir.mkdir(); }
	 * LogManager.getLogManager().readConfiguration(ExcelURLProcessor.class.
	 * getResourceAsStream("/logging.properties")); } catch (IOException e) {
